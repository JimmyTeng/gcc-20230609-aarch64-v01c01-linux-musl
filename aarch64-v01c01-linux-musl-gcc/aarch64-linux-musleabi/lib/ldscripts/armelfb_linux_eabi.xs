...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/devcloud/workspace/gcc_source/build/aarch64-linux-musl/aarch64_linux_musl_build_dir/aarch64-linux-musl/aarch64-linux-musleabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
