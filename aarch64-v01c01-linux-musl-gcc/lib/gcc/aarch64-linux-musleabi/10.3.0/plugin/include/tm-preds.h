/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/devcloud/workspace/gcc_source/build/aarch64-linux-musl/../../open_source/aarch64-linux-musl-build_src/gcc-10.3.0/gcc/config/aarch64/aarch64.md'.  */
